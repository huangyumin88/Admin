...
type LoginRegisterReq struct {
	...
	Email  string `json:"email,omitempty" v:"required-without:Email|max-length:30|passport" dc:"邮箱"`
	...
	SmsCode      string `json:"smsCode" v:"required-with:Phone|size:6" dc:"邮箱验证码"`
}
