...
// internalBankCardsDao is internal type for wrapping internal DAO implements.
type internalBankCardsDao = *internal.BankCardsDao

// bankCardsDao is the data access object for table app_card_bank_cards.
// You can define custom methods on it to extend its functionality as you wish.
type bankCardsDao struct {
	internalBankCardsDao
}

var (
	// BankCards is globally public accessible object for table app_card_bank_cards operations.
	BankCards = bankCardsDao{
		internal.NewBankCardsDao(),
	}
)

// 解析分库
func (daoThis *bankCardsDao) ParseDbGroup(ctx context.Context, dbGroupSelData ...map[string]interface{}) string {
	group := daoThis.Group()
	// 分库逻辑
...
// 解析分表
func (daoThis *bankCardsDao) ParseDbTable(ctx context.Context, dbTableSelData ...map[string]interface{}) string {
	table := daoThis.Table()
	// 分表逻辑
...
// 解析分库分表（对外暴露使用）
func (daoThis *bankCardsDao) ParseDbCtx(ctx context.Context, dbSelDataList ...map[string]interface{}) *gdb.Model {
...
// 解析insert
func (daoThis *bankCardsDao) ParseInsert(insert map[string]interface{}) gdb.ModelHandler {
...
// hook insert
func (daoThis *bankCardsDao) HookInsert(data map[string]interface{}) gdb.HookHandler {
...
// 解析update
func (daoThis *bankCardsDao) ParseUpdate(update map[string]interface{}) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
...
// hook update
func (daoThis *bankCardsDao) HookUpdate(data map[string]interface{}, idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *bankCardsDao) HookDelete(idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析field
func (daoThis *bankCardsDao) ParseField(field []string, fieldWithParam map[string]interface{}, afterField *[]string, afterFieldWithParam map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range field {
...
// hook select
func (daoThis *bankCardsDao) HookSelect(afterField *[]string, afterFieldWithParam map[string]interface{}) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析filter
func (daoThis *bankCardsDao) ParseFilter(filter map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
...
// 解析group
func (daoThis *bankCardsDao) ParseGroup(group []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range group {
...
// 解析order
func (daoThis *bankCardsDao) ParseOrder(order []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range order {
...
// 解析join
func (daoThis *bankCardsDao) ParseJoin(joinCode string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
