...
// internalCardCountriesDao is internal type for wrapping internal DAO implements.
type internalCardCountriesDao = *internal.CardCountriesDao

// cardCountriesDao is the data access object for table app_card_countries.
// You can define custom methods on it to extend its functionality as you wish.
type cardCountriesDao struct {
	internalCardCountriesDao
}

var (
	// CardCountries is globally public accessible object for table app_card_countries operations.
	CardCountries = cardCountriesDao{
		internal.NewCardCountriesDao(),
	}
)

// 解析分库
func (daoThis *cardCountriesDao) ParseDbGroup(ctx context.Context, dbGroupSelData ...map[string]interface{}) string {
	group := daoThis.Group()
	// 分库逻辑
...
// 解析分表
func (daoThis *cardCountriesDao) ParseDbTable(ctx context.Context, dbTableSelData ...map[string]interface{}) string {
	table := daoThis.Table()
	// 分表逻辑
...
// 解析分库分表（对外暴露使用）
func (daoThis *cardCountriesDao) ParseDbCtx(ctx context.Context, dbSelDataList ...map[string]interface{}) *gdb.Model {
...
// 解析insert
func (daoThis *cardCountriesDao) ParseInsert(insert map[string]interface{}) gdb.ModelHandler {
...
// hook insert
func (daoThis *cardCountriesDao) HookInsert(data map[string]interface{}) gdb.HookHandler {
...
// 解析update
func (daoThis *cardCountriesDao) ParseUpdate(update map[string]interface{}) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
...
// hook update
func (daoThis *cardCountriesDao) HookUpdate(data map[string]interface{}, idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *cardCountriesDao) HookDelete(idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析field
func (daoThis *cardCountriesDao) ParseField(field []string, fieldWithParam map[string]interface{}, afterField *[]string, afterFieldWithParam map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range field {
...
// hook select
func (daoThis *cardCountriesDao) HookSelect(afterField *[]string, afterFieldWithParam map[string]interface{}) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析filter
func (daoThis *cardCountriesDao) ParseFilter(filter map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for k, v := range filter {
			...
			case daoThis.Columns().IsoName:
				m = m.WhereLike(tableThis+`.`+k, `%`+gconv.String(v)+`%`)
			case daoThis.Columns().CurrencyName:
				m = m.WhereLike(tableThis+`.`+k, `%`+gconv.String(v)+`%`)
			case `timeRangeStart`:
...
// 解析group
func (daoThis *cardCountriesDao) ParseGroup(group []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range group {
...
// 解析order
func (daoThis *cardCountriesDao) ParseOrder(order []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range order {
...
// 解析join
func (daoThis *cardCountriesDao) ParseJoin(joinCode string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
