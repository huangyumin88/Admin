...
<!--		</ElFormItem>-->
		<ElFormItem prop="cate_id">
			<MySelect v-model="queryCommon.data.cate_id" :placeholder="t('app.cardCategoriesSub.name.cate_name')" :api="{ code: t('config.VITE_HTTP_API_PREFIX') + '/app/cardCategories/list' }" style="width: 250px;" />
		</ElFormItem>
		<ElFormItem prop="name">
			<ElInput v-model="queryCommon.data.name" :placeholder="t('app.cardCategoriesSub.name.name')" minlength="1" maxlength="255" :clearable="true" />
		</ElFormItem>
		<ElFormItem prop="isActive" style="width: 120px;">
			<ElSelectV2 v-model="queryCommon.data.isActive" :options="tm('common.status.whether')" :placeholder="t('app.cardCategoriesSub.name.isActive')" :clearable="true" />
		</ElFormItem>
		<ElFormItem prop="isStop" style="width: 120px;">
			<ElSelectV2 v-model="queryCommon.data.isStop" :options="tm('common.status.whether')" :placeholder="t('app.cardCategoriesSub.name.isStop')" :clearable="true" />
		</ElFormItem>
		<ElFormItem prop="sub_id">
			<ElInput v-model="queryCommon.data.sub_id" :placeholder="t('app.cardCategoriesSub.name.sub_id')" minlength="1" maxlength="30" :clearable="true" />
		</ElFormItem>
