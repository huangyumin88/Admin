...
const initRouteList = [
    {
        ...
        children: [
            ...
            {
                path: '/app/cardCategories',
                component: async () => {
                    const component = await import('@/views/app/cardCategories/Index.vue')
                    component.default.name = '/app/cardCategories'
                    return component
                },
            ...
            },
            {
                path: '/user/wallets',
                component: async () => {
                    const component = await import('@/views/user/wallets/Index.vue')
                    component.default.name = '/user/wallets'
                    return component
                },
                meta: { isAuth: true, keepAlive: true, componentName: '/user/wallets' }
            },
            {
                path: '/orders/orders',
                component: async () => {
                    const component = await import('@/views/orders/orders/Index.vue')
                    component.default.name = '/orders/orders'
                    return component
                },
